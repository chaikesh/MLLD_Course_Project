...
from cvt_same_batch_ssp import BiGRU_CTC
import numpy as np
...
initial_model_path='./model_cvt_same_batch_ssp_2'+str(FLAGS.task_index)+'/model.ckpt'
...
ASR=BiGRU_CTC(FLAGS=FLAGS,num_features=num_features,initial_learning_rate=0.001,beam_width=20,top_paths=3,stale=stale_parameter); ## ASR object created
...
ASR.model_train(labeled_tr_inputs=x_l,labeled_tr_targets=y_l,unlabeled_tr_inputs=x_u,
                ...
                num_epochs=700,model_path_sav=initial_model_path,model_path_res=initial_model_path,re_train=True);
