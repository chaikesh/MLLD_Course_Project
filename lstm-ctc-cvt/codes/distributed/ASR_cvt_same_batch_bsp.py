...
from cvt_same_batch_bsp import BiGRU_CTC
import numpy as np
...
def data_extraction(FLAGS):    ### num_features are 13*3=39 mfcc unnormalised
    ...
    train_file_l="/home/karanm/mlld/project/lstm-ctc_final/data_lists/shard_l_"+str(FLAGS.task_index+1); 
    train_file_u="/home/karanm/mlld/project/lstm-ctc_final/data_lists/shard_ul_"+str(FLAGS.task_index+1);
...
initial_model_path='./model_cvt_same_batch_bsp'+str(FLAGS.task_index)+'/model.ckpt'
...
# index=np.random.choice(len(test_x),500,replace=False);
...
ASR.model_train(labeled_tr_inputs=x_l,labeled_tr_targets=y_l,unlabeled_tr_inputs=x_u,
                ...
                num_epochs=700,model_path_sav=initial_model_path,model_path_res=initial_model_path,re_train=False);
