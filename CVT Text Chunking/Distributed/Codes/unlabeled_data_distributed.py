...
class UnlabeledDataReader(object):
  def __init__(self, config, task_index, starting_file=0, starting_line=0, one_pass=False):
    self.config = config
